                ...
                @if ($subkeg->kak->count() > 0)
                    @if($jenis == 'pdf')
                                        ...
                                        <td>Rp.
                                            @php
                                                ...
                                                foreach ($subkeg->kak as $kak) {
                                                    if($kak->kode_subkeg == $subkeg->kode){
                                                        if($periode->sesi == 'rka'){
                        ...
                        <table class="table table-bordered border-dark table-sm fs-7" id="tblkak">
                            ...
                            <tbody>
                                <tr>
                                    <th colspan="6" class="text-start">Belanja Barang</th>
                                    <th class="text-end">
                                        @php
                                            $totalssh = 0;
                                            foreach ($rekap as $r){
                                                if ($r->tipe_keb == 'ssh' && $r->kode_subkeg == $subkeg->kode){
                                                    $totalssh += $r->total;
                                                }
                                            }

                                            echo str_replace(',', '.', number_format($totalssh));
                                        @endphp
                                    </th>
                                </tr>
                                ...
                                <tr>
                                    <th colspan="6" class="text-start">Belanja Jasa</th>
                                    <th class="text-end">
                                        @php
                                            $totalsbu = 0;
                                            foreach ($rekap as $r){
                                                if ($r->tipe_keb == 'sbu' && $r->kode_subkeg == $subkeg->kode){
                                                    $totalsbu += $r->total;
                                                }
                                            }

                                            echo str_replace(',', '.', number_format($totalsbu));
                                        @endphp
                                    </th>
                                </tr>
                                @foreach ($rekap as $r)
                                ...
                                <tr>
                                    <th colspan="6" class="text-start">Usulan SSH / SBU</th>
                                    <th class="text-end">
                                        @php
                                            $totalusul = 0;
                                            foreach ($rekap as $r){
                                                if (($r->tipe_keb == 'usulanssh' || $r->tipe_keb == 'usulansbu') && $r->kode_subkeg == $subkeg->kode){
                                                    $totalusul += $r->total;
                                                }
                                            }

                                            echo str_replace(',', '.', number_format($totalusul));
                                        @endphp
                                    </th>
                                </tr>
                                @foreach ($rekap as $r)
                                ...
                                <tr>
                                    <th colspan="6" class="text-start">Belanja Non SSH / SBU</th>
                                    <th class="text-end">
                                        @php
                                            $totalother = 0;
                                            foreach ($rekapother as $ro){
                                                if ($ro->kode_subkeg == $subkeg->kode){
                                                    $totalother += $ro->total;
                                                }
                                            }

                                            echo str_replace(',', '.', number_format($totalother));
                                        @endphp
                                    </th>
                                </tr>
                                @foreach ($rekapother as $ro)
