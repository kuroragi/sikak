...
<div class="table-responsive col-lg-12">
    ...
    <form action="/laporan_skpd" class="mb-3">
    ...
    @if(request('periode'))
    <a href="" class="my-3"><button class="btn btn-primary"><i class="fa fa-print"></i> Print Semua Laporan {{ strtoupper(request('tipe')) }}</button></a>
