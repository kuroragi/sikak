        ...
        @elseif($jenis == 'pdf')
            ...
            <div class="mb-3 pb-3">
                <table class="table table-borderless fs-8 m-0 p-0 align-middle mb-3 pb-3">
                    ...
                    @if ($kak->kelompokbelanja_id == 2 || $kak->kelompokbelanja_id == 2)
            ...
            <div class="table-responsive col-lg-12">
                ...
                <tbody id="tbody">
                    ...
                    @foreach ($kak->kebutuhanakt as $keb)
                        ...
                        <tr class="f-8">
                            <td class="fs-8 text-center align-middle">{{ $loop->iteration }}</td>
                            <td class="w-40 p-0 m-0 fs-8">
                                @if ($keb->tipe_keb == 'ssh')
                                    {{ $keb->ssh->ket }}
                                @elseif ($keb->tipe_keb == 'usulanssh')
                                    {{ $keb->usulanssh->ket }}
                            ...
                            <td class="p-0 m-0 fs-8 text-center align-middle">
                                @if ($periode->sesi == 'rka')
                                    {{ str_replace('.', ',', $keb->jml_rka) }}
                                @elseif ($periode->sesi == 'kuappas')
                                    {{ str_replace('.', ',', $keb->jml_kuappas) }}
                            ...
                            <td class="p-0 m-0 fs-8 text-end align-middle">
                                @if ($periode->sesi == 'rka')
                                    {{ str_replace(',', '.', number_format($keb->harga_rka)) }}
                                @elseif ($periode->sesi == 'kuappas')
                                    {{ str_replace(',', '.', number_format($keb->harga_kuappas)) }}
