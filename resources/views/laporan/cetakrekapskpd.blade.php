...
.bg-orange {background-color: #fd7e14;}
    ...
    <body>
            @if ($jenis == 'excel')
                ...
                <table>
                    ...
                    <tr>
                        <td></td>
                        <td>Target</td>
                        <td>: {{ $kak->volkelkeg }} {{ $kak->subkeg->satuan->satuan }}</td>
                    </tr>
                    <tr>
                    ...
                    @else
                        ...
                        <tr>
                            <td></td>
                            <td>Deskripsi Aktivtas</td>
                            <td>: {{ $kak->deskrip }}</td>
                        </tr>
                        <tr>
                            <td></td>
                            <td>Bagian/Bidang/Sekretariat/UPTD</td>
                            <td>: {{ $kak->bidang_sekretariat }}</td>
                        </tr>
                        <tr>
                            <td></td>
                            <td>Subbag/Seksi/Sub-koordinator</td>
                            <td>: {{ $kak->subbagdkk }}</td>
                        </tr>
                    ...
                    <table>
                        <thead>
                            <tr>
                                ...
                                <th align="center" width="40">Rincian Gaji</th>
                                <th align="center" width="20">Anggaran</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                ...
                @elseif ($kak->kelompokbelanja_id == 3)
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <th colspan="5" align="center">Kebutuhan Belanja</th>
                        </tr>
                        <tr>
                            <th align="center">Uraian Kebutuhan</th>
                        ...
                        <tr class="fs-">
                            ...
                            @php
                                ...
                                foreach($kak->kebutuhanakt as $keb){
                                    if($periode->sesi == 'rka'){
                                    $total_kak += $keb->sum('total_rka');
                                    }else if($periode->sesi == 'kuappas'){
                                    $total_kak += $keb->sum('total_kuappas');
                                    }else if($periode->sesi == 'apbd'){
                                    $total_kak += $keb->sum('total_apbd');
                                    }else if($periode->sesi == 'final'){
                                    $total_kak += $keb->sum('total_final');
                                    }
                                }
                    ...
                    <table style="border: 1px black solid;" border="1">
                        <thead>
                            <tr class="text-center fs-7 text-wrap">
                                ...
                                <th colspan="5" align="center">Kebutuhan Sumber Daya</th>
                                <th colspan="5" align="center">Kebutuhan Belanja</th>
                            </tr>
                            <tr class="text-center fs-7 text-wrap">
                                <th colspan="2" align="center">Personil</th>
                                <th colspan="2" align="center">Alat</th>
                                <th rowspan="2" align="center" valign="middle" width="20">Data/ Dokumen</th>
                                <th rowspan="2" align="center" valign="middle" width="40">Uraian Kebutuhan</th>
                                <th rowspan="2" align="center" valign="middle">Vol</th>
                                <th rowspan="2" align="center" valign="middle">Satuan</th>
                                <th rowspan="2" align="center" valign="middle" width="20">Harga</th>
                                <th rowspan="2" align="center" valign="middle" width="20">Total</th>
                            </tr>
                            <tr class="text-center fs-7 text-wrap">
                                <th align="center" width="20">Rincian</th>
                        ...
                        <tbody>
                            <tr class="fs-7 bg-green">
                                <th colspan="9">Total Anggaran</th>
                                <th colspan="2" align="right">
                                    @php
                                        $total_kak = 0;
                            ...
                            @foreach ($kak->tahap as $thp)
                                <tr class="fs-8 bg-orange">
                                    <th align="center">{{ chr(64+$loop->iteration) }}</th>
                                ...
                                @foreach ($thp->aktivitas as $akt)
                                    <tr class="fs-8 bg-info">
                                        ...
                                        <th colspan="2" class="text-end" align="right">
                                            @if ($periode->sesi == 'rka')
            ...
            @elseif($jenis == 'pdf')
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h5 class="h2 text-center">DAFTAR REKAP KAK SKPD</h5>
                </div>
                <h6>{{ $skpd->kode }} - {{ strtoupper($skpd->name) }}</h6>
                <div class="table-responsive col-lg-12 mt-3">
                        
                    <table class="table table-bordered border-dark table-sm fs-7" id="tblkak">
                        <thead>
                            <tr class="text-center fs-7 text-wrap">
                                <th scope="col" class="text-align-middle" class="align-middle w-3">No</th>
                                <th scope="col" class="text-align-middle">Kelompok Belanja</th>
                                <th scope="col" class="text-align-middle">Program Bidang/Kegiatan/Sub Kegiatan/KAK</th>
                                <th scope="col" class="text-align-middle">Indikator</th>
                                <th scope="col" class="text-align-middle" class="w-5">Target</th>
                                <th scope="col" class="text-align-middle" class="w-5">Satuan</th>
                                <th scope="col" class="text-align-middle">Sub Unit</th>
                                <th scope="col" class="text-align-middle">Pagu</th>
                            </tr>
                        </thead>
                            ...
                            <tbody>
                                <tr class="tbold">
                                    ...
                                    <td class="text-end">
                                        @php
                                            $total = 0;
                                            foreach ($skpd->biduruses as $bidurus) {
                                                    ...
                                                    foreach ($progbid->kegprog as $kegprog) {
                                                        foreach ($kegprog->subkeg as $subkeg) {
                                                            foreach ($subkeg->kak as $kak) {
                                                                $total += $kak->kebutuhanakt->sum($sesi['total']);
                                                            }
                                                        }
                                                    }
                                                }
                                ...
                                @foreach ($skpd->biduruses as $bidurus)
                                    @foreach ($bidurus->progbid as $progbid)
                                        ...
                                        @if ($j>0)
                                            <tr class="tbold py-1">
                                                <td></td>
                                                <td colspan="6">[{{ $progbid->kode }}] {{ $progbid->ket }}</td>
                                                <td class="text-end">
                                            ...
                                            @if ($kj>0)
                                                ...
                                                @foreach ($progbid->kegprog as $kegprog)
                                                    <tr class="tbold py-1">
                                                        <td></td>
                                                        <td colspan="6">[{{ $kegprog->kode }}] {{ $kegprog->ket }}</td>
                                                        <td class="text-end">
                                                            @php
                                                                $totalkegprog = 0;
                                                                foreach ($kegprog->subkeg as $subkeg) {
                                                                    foreach ($subkeg->kak as $kak) {
                                                                        $totalkegprog += $kak->kebutuhanakt->sum($sesi['total']);
                                                                    }
                                                                }
                                                                echo str_replace(',', '.', number_format($totalkegprog));
                                                            @endphp
                                                        </td>
                                                    </tr>
                                                    @foreach ($kegprog->subkeg as $subkeg)
                                                        <tr class="tbold bg-info">
                                                            <td class="text-center">{{ chr(64+$loop->iteration) }}</td>
                                                            <td colspan="2">[{{ $subkeg->kode }}] {{ $subkeg->ket }}</td>
                                                            <td>{{ $subkeg->indikator }}</td>
                                                            <td></td>
                                                            <td class="text-center">{{ $subkeg->satuan->satuan }}</td>
                                                            <td></td>
                                                            <td class="text-end">
                                                                @php
                                                                $totalsubkeg = 0;
                                                                foreach ($subkeg->kak as $kak) {
                                                                    $totalsubkeg += $kak->kebutuhanakt->sum($sesi['total']);
                                                                }
                                                                echo str_replace(',', '.', number_format($totalsubkeg));
                                                            @endphp
                                                            </td>
                                                        </tr>
                                                        ...
                                                        @foreach ($subkeg->kak as $kak)
                                                            <tr>
                                                                ...
                                                                <td>{{ $kak->ket??'' }}</td>
                                                                <td>{{ $kak->outakti }}</td>
                                                                <td class="text-center">{{ $kak->voloutakti }}</td>
                                                                <td class="text-center">{{ $kak->satoutakti }}</td>
                                                                <td>{{ $kak->subunit->name??$kak->user->name??'' }}</td>
                                                                <td class="text-end">{{ str_replace(',', '.', number_format($kak->kebutuhanakt->sum($sesi['total']))) }}</td>
                                                            </tr>
                                                        @endforeach
                                                    @endforeach
                                                @endforeach
                                            ...
                                            <td class="text-end">
                                                @php
                                                    ...
                                                    foreach ($progbid->kegprog as $kegprog) {
                                                        foreach ($kegprog->subkeg as $subkeg) {
                                                            foreach ($subkeg->kak as $kak) {
                                                                $totalprogbid += $kak->kebutuhanakt->sum($sesi['total']);
                                                            }
                                                        }
                                                    }
                                                    echo str_replace(',', '.', number_format($totalprogbid));
                                                @endphp
                                            </td>
                                        </tr>
                                        @foreach ($progbid->kegprog as $kegprog)
