    ...
    <table class="table table-striped table-sm" id="tbl">
        ...
        <tbody id="tbody">
            @foreach ($s->progbid as $pb)
                <tr class="fs-7">
                  <td></td>
                  <td class="tbold" colspan="7">{{ $pb->ket }}</td>
                  <td class="tbold text-end" colspan="2">{{ number_format($pb->total_anggaran_progbid) }}</td>
                </tr>
                @foreach ($pb->kegprog as $kp)
                    <tr class="fs-7">
                      <td></td>
                      <td class="tbold" colspan="7">{{ $kp->ket }}</td>
                      <td class="tbold text-end" colspan="2">{{ number_format($kp->total_anggaran_kegprog) }}</td>
                    </tr>
                        ...
                        <td colspan="7">
                            ...
                            <tbody>
                                ...
                                <tr class="bb-0">
                                    ...
                                    <td class="text-wrap w-20">{{ $kakg->subunit->name ?? $kakg->sub_unit ?? '' }}</td>
                                ...
                                <tr class="bb-0">
                                    ...
                                    <td class="text-wrap text-center w-5">{{ $sb->satuan->name }}</td>
                                <td class="w-20">{{ $kakr->subunit->name ?? $kakr->sub_unit ?? '' }}</td>
                            ...
                            @foreach ($sb->kak as $kak)
                                <tr class="bb-0">
                                    ...
                                    <td class="text-wrap text-center w-5">{{ $sb->satuan->name }}</td>
                                    <td class="text-wrap w-20">{{ $kak->subunit->name ?? $kak->sub_unit ?? '' }}</td>
            ...
            @endforeach
            <tr>
              <td class="tbold" colspan="7">Total Pagu</td>
              <td class="tbold text-end" colspan="3">{{ number_format($s->total_anggaran_skpd) }}</td>
            </tr>
        </tbody>
    </table>
