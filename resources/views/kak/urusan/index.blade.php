...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Urusan Pemerintah</h1>
    <div class="btn-toolbar mb-2 mb-md-0">
    </div>
</div>

<div class="table-responsive">
    <button class="btn btn-block btn-primary mb-3" id="addbutton" data-bs-toggle="modal" data-bs-target="#addmodal"><i class="fa fa-plus"></i> Tambah Urusan</button>
      ...
      <tbody id="tbody">
        @foreach ($urusan as $u)
          <tr class="align-middle">
              ...
              <td>{{ $u->kode }}</td>
              <td>{{ $u->ket }}</td>
              <td class="text-center">@if ($u->status == 1) <i class="text-green fa fa-square"></i> @else <i class="text-red fa fa-square"></i> @endif</td>
              <td class="text-center">
                <button class="btn btn-warning btn-sm" title="Edit Urusan" id="editbutton" data-bs-toggle="modal" data-bs-target="#editmodal"><a kode="{{ $u->kode }}"></a><i class="fa fa-edit"></i></button>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form method="post" action="/urusan" class="mb-5">
            @csrf
            <div class="row">
                <div class="col col-xl-12">
                    <div class="mb-3">
                        <label for="kode" class="form-label">Kode Urusan</label>
        ...
        <div class="modal-footer">
          <button type="submit" class="btn btn-success"><i class="fa fa-floppy-disk"></i> Tambah Urusan</button>
        </form>
...
<div class="modal fade" id="editmodal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content">
          ...
          <div class="row">
            <div class="col col-xl-12">
              ...
              <div class="mb-3">
                ...
                <select name="status" id="editstatus" class="form-select" id="addstatus">
      ...
      <div class="modal-footer">
        <button type="submit" class="btn btn-warning"><i class="fa fa-edit"></i> Ubah Urusan</button>
      </form>
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
      </div>
    </div>
...
<script>
      ...
      $("#tbody #editbutton").click(function(){
        ...
        console.log("halo"+kode);
          $.ajax({
          url: '/getdataedit?tbl=urusans&whr=kode&id='+kode,
          type: 'GET',
          success: function(data){
          console.log(data);
            $("#editform").attr("action", "/urusan/"+kode);
