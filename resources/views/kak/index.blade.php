...
@section('container')
    ...
    <div class="accordion mb-3" id="accordionExample">
        <div class="accordion-item">
            <h2 class="accordion-header" id="headingOne">
                <button class="accordion-button bg-orange text-white" type="button" data-bs-toggle="collapse"
                    ...
                    <div id="kakheaderform">
                        <table class="table tbale-boderless fs-7 m-0 p-0 align-middle">
                            <tr class="tbold">
                                ...
                                <td class="w-10"></td>
                                <td>: {{ $kak->subkeg->kegprog->progbid->bidurus->urusan->kode }}
                                    {{ $kak->subkeg->kegprog->progbid->bidurus->urusan->ket }}</td>
                            </tr>
                            <tr class="tbold">
                                <td class="w-5">bidang Urusan</td>
                                <td class="w-10"></td>
                                <td>:
                                    {{ $kak->subkeg->kegprog->progbid->bidurus->kode }}{{ $kak->subkeg->kegprog->progbid->bidurus->ket }}
                                </td>
                            </tr>
                            <tr class="tbold">
                            ...
                            <tr class="tbold">
                                ...
                                <td class="w-10"></td>
                                <td>: {{ $kak->subkeg->kegprog->progbid->kode }} {{ $kak->subkeg->kegprog->progbid->ket }}
                                </td>
                            </tr>
                            <tr>
                                <td class="w-5"></td>
                            ...
                            <tr>
                                <td class="w-5"></td>
                                <td class="w-10">Target</td>
                                <td>: {{ $kak->tarsubkeg }} {{ $kak->sat_target ?? $subkeg->satuan->satuan }}</td>
                            </tr>
                            <tr class="tbold">
                        ...
                        <button class="btn btn-block btn-warning mt-3 w-100" type="submit" id="kakediting"><i
                                class="fa fa-edit"></i> Edit KAK</button>
                        <button class="btn btn-block btn-danger mt-3 w-100" type="submit" id="kakdeleting"
                            data-bs-toggle="modal" title="Hapus Kebutuhan" data-bs-target="#kakdeletemodal"><i
                                class="fa fa-trash"></i> Hapus KAK</button>
                    </div>
                        ...
                        <form action="/kak/{{ $kak->kode }}" method="post">
                            ...
                            <table class="table tbale-boderless fs-7 m-0 p-0 align-middle">
                                ...
                                <tr class="tbold">
                                    <td class="w-5">Program</td>
                                    <td class="w-10"></td>
                                    <td>: {{ $kak->subkeg->kegprog->progbid->kode }}
                                        {{ $kak->subkeg->kegprog->progbid->ket }}</td>
                                </tr>
                                <tr>
                                    <td class="w-5"></td>
                                    <td class="w-10">Capaian Program</td>
                                ...
                                <tr>
                                    <td class="w-5"></td>
                                    <td class="w-10">Indikator</td>
                                    <td><input type="text" name="icapaianprog" class="form-control"
                                            value="{{ $kak->icapaianprog }}"></td>
                                </tr>
                                <tr>
                                    <td class="w-5"></td>
                                    <td class="w-10">Target</td>
                                    <td>
                                        <div class="input-group">
                                            <input type="text"name="volcapprog" class="form-control"
                                                value="{{ $kak->volcapprog }}">
                                            <input type="text"name="satcapprog" class="form-control"
                                                value="{{ $kak->satcapprog }}">
                                        </div>
                                    </td>
                                </tr>
                                <tr class="tbold">
                                ...
                                <tr>
                                    ...
                                    <td class="w-10">Indikator</td>
                                    <td>
                                        <input type="text"name="ihaskeg" class="form-control"
                                            value="{{ $kak->ihaskeg }}">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="input-group">
                                            <input type="text"name="volhaskeg" class="form-control"
                                                value="{{ $kak->volhaskeg }}">
                                            <input type="text"name="sathaskeg" class="form-control"
                                                value="{{ $kak->sathaskeg }}">
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="w-10">Indikator</td>
                                    <td>
                                        <input type="text"name="ikeluarankeg" class="form-control"
                                            value="{{ $kak->ikeluarankeg }}">
                                    </td>
                                </tr>
                                <tr>
                                    <td class="w-5"></td>
                                    ...
                                    <td>
                                        <div class="input-group">
                                            <input type="text"name="volkelkeg" class="form-control"
                                                value="{{ $kak->volkelkeg }}">
                                            <input type="text"name="satkelkeg" class="form-control"
                                                value="{{ $kak->satkelkeg }}">
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="input-group">
                                            <input type="text"name="tarsubkeg" class="form-control"
                                                value="{{ $kak->tarsubkeg }}">
                                ...
                                <tr>
                                    ...
                                    <td class="w-10">Indikator</td>
                                    <td>
                                        <input type="text"name="outakti" class="form-control"
                                            value="{{ $kak->outakti }}">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="input-group">
                                            <input type="text"name="voloutakti" class="form-control"
                                                value="{{ $kak->voloutakti }}">
                                            <input type="text"name="satoutakti" class="form-control"
                                                value="{{ $kak->satoutakti }}">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                        ...
                                        <select name="pencetuskebe_id" id="" class="form-control">
                                            @foreach ($pencetus as $penc)
                                                @if ($kak->kelompokbelanja_id == $penc->kebe_id)
                                                    <option @if ($kak->pencetuskebe_id == $penc->id) selected @endif
                                                        value="{{ $penc->id }}">{{ $penc->pencetus }}</option>
                                                @endif
                                            @endforeach
                                        </select>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="input-group">
                                            <input type="text" name="dari" class="form-control" id="editdari"
                                                value="{{ $kak->dari }}">
                                            <span class="input-group-text">s/d</span>
                                            <input type="text" name="sampai" class="form-control" id="editsampai"
                                                value="{{ $kak->sampai }}">
                                        </div>
                                    </td>
                                </tr>
                                    ...
                                    <td>
                                        <select name="lokasi" id="" class="form-control">
                                            ...
                                            @foreach ($lokasi as $lok)
                                                <option @if ($kak->lokasi == $lok->id) selected @endif
                                                    value="{{ $lok->id }}">{{ $lok->ket }}</option>
                                            @endforeach
                                        </select>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="w-10">Bagian/Bidang/Sekretariat/UPTD</td>
                                    <td>
                                        <input type="text" name="bidang_sekretariat" class="form-control"
                                            @if (auth()->user()->role_slug == 'askpd') value="{{ old('bidang_sekretariat', auth()->user()->kode_sub) }}" @else value="{{ $kak->bidang_sekretariat }}" @endif
                                            hidden>
                                        <select class="form-control" @if (auth()->user()->role_slug == 'askpd') disabled @endif>
                                            @foreach ($subunit as $sub)
                                                <option value="{{ $sub->kode }}"
                                                    @if ($sub->kode == auth()->user()->kode_sub) selected @endif>{{ $sub->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                </tr>
                                <tr>
                                    ...
                                    <td class="w-10">Subbag/Seksi/Sub-koordinator</td>
                                    <td>
                                        <input type="text" name="subbagdkk" class="form-control" id="editdari"
                                            value="{{ $kak->subbagdkk }}">
                                    </td>
                                </tr>
                            </table>
                            <button class="btn btn-block btn-warning mt-3 w-100" type="submit"><i
                                    class="fa fa-edit"></i> Ubah header KAK</button>
                        </form>
                        <button class="btn btn-block btn-danger mt-3 w-100" type="submit" id="kakeditcancel"><i
    ...
    @if ($kak->kelompokbelanja_id == 2)
        <a
            href="/skpdprogkak?kode_skpd={{ request('kode_skpd') }}&kode={{ $kak->subkeg->kode }}&periode={{ request('periode') }}"><button
                class="btn btn-block btn-warning mb-3" id="backbutton"><i class="fa fa-angles-left"></i>
                Kembali</button></a>

        @if (auth()->user()->role_slug == 'askpd')
            <button class="btn btn-block btn-primary mb-3" id="printout" data-bs-toggle="modal"
                data-bs-target="#printoutmodal"><i class="fa fa-print"></i> Print</button>
            <div id="addformdivgaji">
                @if ($periode->proses == 'berjalan')
                    <form action="/kebutuhanakt" method="POST">
                        ...
                        <div class="row mb-3">
                            <div class="col-mb-12">
                                <label for="kode" class="form-label"><small class="text-danger">*Mohon Diisi data
                                        Detail terlebih dahulu</small></label>
                            </div>
                            <div class="col-md-6">
                                <div class="group-input">
                                    <input type="text" name="kode_skpd" id="addkode_skpd" class="form-control"
                                        value="{{ request('kode_skpd') }}" hidden>
                                    <input type="text" name="kode_kak" id="addkode_kak" class="form-control"
                                        value="{{ $kak->kode }}" hidden>
                                    <input type="text" name="periode" id="addperiode" class="form-control"
                                        value="{{ request('periode') }}" hidden>
                                    <input type="text" name="tipe_keb" id="addtipe_keb" class="form-control"
                                        value="gaji" hidden>
                                    <input type="text" name="uraian_lain" id="adduraian_lain"
                                        class="form-control @error('uraian_lain') is-invalid @enderror"
                            ...
                            <div class="col-md-5">
                                <div class="group-input">
                                    <input type="text" name="total" id="addtotal"
                                        class="form-control @error('uraian_lain') is-invalid @enderror"
                                        placeholder="total">
                                    @error('total')
                                        <div class="invalid-feedback">
                        ...
                        <button type="submit" class="btn btn-block btn-primary mb-3"><i class="fa fa-plus"></i> Tambah
                            Rincian</button>
                    </form>
                @endif
            </div>
        @elseif (auth()->user()->role_slug == 'admin' || auth()->user()->role_slug == 'pengampu')
            <div id="addformdivgaji">
                <form action="/kebutuhanakt" method="POST">
                    ...
                    <div class="row mb-3">
                        <div class="col-mb-12">
                            <label for="kode" class="form-label"><small class="text-danger">*Mohon Diisi data Detail
                                    terlebih dahulu</small></label>
                        </div>
                        <div class="col-md-6">
                            <div class="group-input">
                                <input type="text" name="kode_skpd" id="addkode_skpd" class="form-control"
                        ...
                        <div class="col-md-5">
                            <div class="group-input">
                                <input type="text" name="total" id="addtotal"
                                    class="form-control @error('uraian_lain') is-invalid @enderror" placeholder="total">
                                @error('total')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
        ...
        <div id="editformdivgaji" style="display: none;">
            <form id="editgajiform" action="/kebutuhanakt" method="POST">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        <div class="group-input">
                            <input type="text" name="kode_skpd" id="editgajikode_skpd" class="form-control"
                                value="{{ request('kode_skpd') }}" hidden>
                            <input type="text" name="kode_kak" id="editgajikode_kak" class="form-control"
                                value="{{ $kak->kode }}" hidden>
                            <input type="text" name="periode" id="editgajiperiode" class="form-control"
                                value="{{ request('periode') }}" hidden>
                            <input type="text" name="tipe_keb" id="editgajitipe_keb" class="form-control"
                                value="gaji" hidden>
                            <input type="text" name="uraian_lain" id="editgajiuraian_lain" class="form-control"
                                placeholder="Rincian Pengeluaran">
                        </div>
                    </div>
                    <div class="col-md-5">
                        <div class="group-input">
                            <input type="text" name="total" id="editgajitotal" class="form-control"
                                placeholder="total">
                        </div>
                    </div>
                </div>
                <button type="submit" class="btn btn-block btn-warning mb-3"><i class="fa fa-plus"></i> Edit
                    Rincian</button>
            </form>
        </div>
                    ...
                    @foreach ($kak->kebutuhanakt as $keb)
                        <tr>
                            ...
                            <td class="text-center">
                                <button class="badge bg-warning border-0" id="editgajibutton"><a
                                        kode="{{ $keb->kode }}" total="{{ $kebut }}"
                                        uraian="{{ $keb->uraian_lain }}"></a><i class="fa fa-edit"></i></button>
                                <button class="badge bg-danger border-0" id="deletekebbutton"
                                    tipe_keb="{{ $keb->tipe_keb }}" datakeb="{{ $keb->kode }}"
                                    data-bs-toggle="modal" title="Hapus Kebutuhan" data-bs-target="#kebdeletemodal"><i
    ...
    @elseif($kak->kelompokbelanja_id == 3)
        <div class="table-responsive col-lg-12">
            ...
            @if (auth()->user()->role_slug == 'askpd')
                @if ($periode->proses == 'berjalan')
                    <button class="btn btn-block btn-primary mb-3" id="a" data-bs-toggle="modal"
                        data-bs-target="#kebutuhanaktaddmodala"><a href="{{ $kak->kode_kak }}"></a><i
                            class="fa fa-plus"></i> Tambah Kebutuhan</button>
                @endif
                <button class="btn btn-block btn-primary mb-3" id="printout" data-bs-toggle="modal"
                    data-bs-target="#printoutmodal"><i class="fa fa-print"></i> Print</button>
            @elseif (auth()->user()->role_slug == 'admin' || auth()->user()->role_slug == 'pengampu')
                ...
                <tbody id="tbody">
                    ...
                    @foreach ($kak->kebutuhanakt as $keb)
                        <tr @if ($keb->berubah == 1) class="bg-yellow" @endif>
                            ...
                            <td>
                                <a class="badge bg-warning border-0" id="editkebbutton" tipe_keb="{{ $keb->tipe_keb }}"
                                    datakeb="{{ $keb->kode }}" data-bs-toggle="modal" title="Edit Kebutuhan"
                                    data-bs-target="#kebeditmodal"><i class="fa fa-edit"></i></a>
                                <a class="badge bg-danger border-0" id="deletekebbutton"
                                    tipe_keb="{{ $keb->tipe_keb }}" datakeb="{{ $keb->kode }}"
                                    data-bs-toggle="modal" title="Hapus Kebutuhan" data-bs-target="#kebdeletemodal"><i
        ...
        @else
            <div class="table-responsive col-lg-12">
                ...
                @if (auth()->user()->role_slug == 'askpd')
                    @if ($periode->proses == 'berjalan')
                        <button class="btn btn-block btn-primary mb-3" id="tahapaddbutton" data-bs-toggle="modal"
                            data-bs-target="#tahapaddmodal"><i class="fa fa-plus"></i> Tambah Tahap</button>
                    @endif
                    <button class="btn btn-block btn-primary mb-3" id="printout" data-bs-toggle="modal"
                        data-bs-target="#printoutmodal"><i class="fa fa-print"></i> Print</button>
                @elseif (auth()->user()->role_slug == 'admin' || auth()->user()->role_slug == 'pengampu')
                        ...
                        @foreach ($kak->tahap as $thp)
                            <tr class="fs-8 bg-orange">
                                ...
                                <th colspan="8">{{ $thp->ket }}
                                    @if (auth()->user()->role_slug == 'askpd')
                                        @if ($periode->proses == 'berjalan')
                                            <button class="badge bg-success border-0" id="aktivitasaddbutton"
                                                data-bs-toggle="modal" data-bs-placement="top" title="Tambah Aktivitas"
                                                data-bs-target="#aktivitasaddmodal"><a thp="{{ $thp->kode }}"></a><i
                                                    class="fa fa-plus"></i></button>
                                            <button class="badge bg-warning border-0" id="tahapeditbutton"
                                                data-bs-toggle="modal" data-bs-placement="top" title="Edit Tahap"
                                                data-bs-target="#tahapeditmodal"><a thp="{{ $thp->kode }}"></a><i
                                ...
                                <th class="text-center">
                                    @if (auth()->user()->role_slug == 'askpd')
                                        @if ($periode->proses == 'berjalan')
                                            <form action="/tahap/{{ $thp->kode }}" id="deletethp" method="post"
                                                class="d-inline">
                                                @method('delete')
                                                @csrf
                                                <input type="hidden" name="periode" value="{{ request('periode') }}">
                                                <input type="hidden" name="kode_kak" value="{{ request('kode') }}">
                                                <input type="hidden" name="kode_skpd"
                                                    value="{{ request('kode_skpd') }}">
                                                <button class="badge bg-danger border-0" data-bs-toogle="tooltip"
                                                    data-bs-placement="top" title="Hapus Tahap"
                                                    onclick="return confirm('Yakin Hapus Tahap?')"><i
                            ...
                            @foreach ($thp->aktivitas as $akt)
                                <tr class="fs-8 bg-info">
                                    ...
                                    <th colspan="8">{{ $akt->ket }}
                                        @if (auth()->user()->role_slug == 'askpd')
                                            @if ($periode->proses == 'berjalan')
                                                <button class="badge bg-warning border-0" id="aktivitaseditbutton"
                                                    data-bs-toggle="modal" data-bs-placement="top" title="Edit Aktivitas"
                                                    data-bs-target="#aktivitaseditmodal"><a akt="{{ $akt->kode }}"
                                                        thp="{{ $akt->kode_thp }}"></a><i
                                                        class="fa fa-edit"></i></button>
                                            @endif
                                        @elseif (auth()->user()->role_slug == 'admin' || auth()->user()->role_slug == 'pengampu')
                                            <button class="badge bg-warning border-0" id="aktivitaseditbutton"
                                                data-bs-toggle="modal" data-bs-placement="top" title="Edit Aktivitas"
                                                data-bs-target="#aktivitaseditmodal"><a akt="{{ $akt->kode }}"
                                                    thp="{{ $akt->kode_thp }}"></a><i class="fa fa-edit"></i></button>
                                        @endif
                                    </th>
                                    <th colspan="2" class="text-end">
                                        @if ($periode->sesi == 'rka')
                                    ...
                                    <th class="text-center">
                                        @if (auth()->user()->role_slug == 'askpd')
                                            @if ($periode->proses == 'berjalan')
                                                <form action="/aktivitas/{{ $akt->kode }}" method="post"
                                                    class="d-inline">
                                                    @method('delete')
                                                    @csrf
                                                    <input type="hidden" name="periode"
                                                        value="{{ request('periode') }}">
                                                    <input type="hidden" name="kode_kak"
                                                        value="{{ request('kode') }}">
                                                    <input type="hidden" name="kode_skpd"
                                                        value="{{ request('kode_skpd') }}">
                                                    <button class="badge bg-danger border-0" data-bs-toogle="tooltip"
                                                        data-bs-placement="top" title="Hapus Aktivitas"
                                                        onclick="return confirm('Yakin Hapus AKtivitas?')"><i
                                                            class="fa fa-circle-xmark"></i></button>
                                                </form>
                                            @endif
                                        @elseif (auth()->user()->role_slug == 'admin' || auth()->user()->role_slug == 'pengampu')
                                ...
                                <tr class="fs-8 border-dark">
                                    ...
                                    <td colspan="2">
                                                            ...
                                                            @if (auth()->user()->role_slug == 'askpd')
                                                                @if ($periode->proses == 'berjalan')
                                                                    <a class="text-decoration-none text-dark"
                                                                        id="personalakteditbutton"
                                                                        pers="{{ $p->kode_pers }}"
                                                                        data-bs-toggle="modal" title="Edit Kebutuhan"
                                                                        data-bs-target="#personalakteditmodal"><i
                                                                            class="fa fa-edit"></i></a>
                                                                    <a class="text-decoration-none text-dark"
                                                                        id="personalaktdeletebutton"
                                                                        pers="{{ $p->kode_pers }}"
                                                                        data-bs-toggle="modal" title="Edit Kebutuhan"
                                                                        data-bs-target="#personalaktdeletemodal"><i
                                                                            class="fa fa-trash"></i></a>
                                                                @endif
                                                            @elseif (auth()->user()->role_slug == 'admin' || auth()->user()->role_slug == 'pengampu')
                                                                <a class="text-decoration-none text-dark"
                                                                    id="personalakteditbutton"
                                                                    pers="{{ $p->kode_pers }}" data-bs-toggle="modal"
                                        ...
                                        @if (auth()->user()->role_slug == 'askpd')
                                            @if ($periode->proses == 'berjalan')
                                                <button class="badge bg-success border-0" id="personalaktaddbutton"
                                                    data-bs-toggle="modal" data-bs-placement="top"
                                                    data-bs-target="#personalaktaddmodal" title="Tambah Personil"><a
                                                        kode_akt="{{ $akt->kode }}"></a><i
                                                        class="fa fa-plus"></i></button>
                                            @endif
                                        @elseif (auth()->user()->role_slug == 'admin' || auth()->user()->role_slug == 'pengampu')
                                            <button class="badge bg-success border-0" id="personalaktaddbutton"
                                    ...
                                    <td colspan="2">
                                                    ...
                                                    <tr>
                                                        <td class="w-70 m-0 p-0 text-wrap">
                                                            ...
                                                            @if (auth()->user()->role_slug == 'askpd')
                                                                @if ($periode->proses == 'berjalan')
                                                                    <a class="text-decoration-none text-dark"
                                                                        id="instruakteditbutton"
                                                                        instruakt="{{ $i->kode_instruakt }}"
                                                                        data-bs-toggle="modal" title="Edit Instrumen"
                                                                        data-bs-target="#instruakteditmodal"><i
                                                                            class="fa fa-edit"></i></a>
                                                                    <a class="text-decoration-none text-dark"
                                                                        id="instruaktdeletebutton"
                                                                        instruakt="{{ $i->kode_instruakt }}"
                                                                        data-bs-toggle="modal"
                                                                        title="Hapus Instrumen Aktivitas KAK"
                                                                        data-bs-target="#instruaktdeletemodal"><i
                                                                            class="fa fa-trash"></i></a>
                                                                @endif
                                                            @elseif (auth()->user()->role_slug == 'admin' || auth()->user()->role_slug == 'pengampu')
                                                                <a class="text-decoration-none text-dark"
                                        ...
                                        @if (auth()->user()->role_slug == 'askpd')
                                            @if ($periode->proses == 'berjalan')
                                                <button class="badge bg-success border-0" id="instruaktaddbutton"
                                                    data-bs-toggle="modal" data-bs-placement="top" title="Tambah Alat"
                                                    data-bs-target="#instruaktaddmodal"><a
                                                        kode_akt="{{ $akt->kode }}"></a><i
                                                        class="fa fa-plus"></i></button>
                                            @endif
                                        @elseif (auth()->user()->role_slug == 'admin' || auth()->user()->role_slug == 'pengampu')
                                    ...
                                    <td class="text-wrap">
                                        @foreach ($akt->dataakt as $d)
                                            @if ($d->$sesi_periode != 3)
                                                ...
                                                @if (auth()->user()->role_slug == 'askpd')
                                                    @if ($periode->proses == 'berjalan')
                                                        <a class="text-decoration-none text-dark" id="dataakteditbutton"
                                                            dataakt="{{ $d->kode_dataakt }}" data-bs-toggle="modal"
                                                            title="Edit Kebutuhan" data-bs-target="#dataakteditmodal"><i
                                                                class="fa fa-edit"></i></a>
                                                        <a class="text-decoration-none text-dark" id="dataaktdeletebutton"
                                                            dataakt="{{ $d->kode_dataakt }}" data-bs-toggle="modal"
                                                            title="Hapus Data Aktivitas KAK"
                                                            data-bs-target="#dataaktdeletemodal"><i
                                                                class="fa fa-trash"></i></a>
                                                    @endif
                                                @elseif (auth()->user()->role_slug == 'admin' || auth()->user()->role_slug == 'pengampu')
                                                    <a class="text-decoration-none text-dark" id="dataakteditbutton"
                                        ...
                                        @if (auth()->user()->role_slug == 'askpd')
                                            @if ($periode->proses == 'berjalan')
                                                <button class="badge bg-success border-0" id="dataaktaddbutton"
                                                    data-bs-toggle="modal" data-bs-placement="top" title="Tambah Data"
                                                    data-bs-target="#dataaktaddmodal"><a
                                                        kode_akt="{{ $akt->kode }}"></a><i
                                                        class="fa fa-plus"></i></button>
                                            @endif
                                        @elseif (auth()->user()->role_slug == 'admin' || auth()->user()->role_slug == 'pengampu')
                                    ...
                                    <td colspan="5">
                                                ...
                                                @if ($keb->$sesi_periode != 3)
                                                    <tr @if ($keb->berubah == 1) class="bg-yellow" @endif>
                                                        <td class="w-50 p-0 m-0">
                                                            @if ($keb->tipe_keb == 'ssh')
                                                                <e title="{{ $keb->ssh->ket ?? '' }}">
                                                                    ...{{ substr($keb->ssh->ket, -30) ?? '' }}</e>
                                                            @elseif ($keb->tipe_keb == 'usulanssh')
                                                                <e title="{{ $keb->usulanssh->ket ?? '' }}">
                                                                    ...{{ substr($keb->usulanssh->ket, -30) ?? '' }}</e>
                                                            @elseif ($keb->tipe_keb == 'sbu')
                                                                <e title="{{ $keb->sbu->ket ?? '' }}">
                                                                    ...{{ substr($keb->sbu->ket, -30) ?? '' }}</e>
                                                            @elseif ($keb->tipe_keb == 'usulansbu')
                                                                <e title="{{ $keb->usulansbu->ket ?? '' }}">
                                                                    ...{{ substr($keb->usulansbu->ket, -30) ?? '' }}</e>
                                                            @elseif ($keb->tipe_keb == 'other')
                                                                <e title="{{ $keb->uraian_lain }}">
                                                                    ...{{ substr($keb->uraian_lain, -30) ?? '' }}</e>
                                                            @endif
                                                            <a class="text-decoration-none text-dark" id="editkebbutton"
                                                                tipe_keb="{{ $keb->tipe_keb }}"
                                                                datakeb="{{ $keb->kode }}" data-bs-toggle="modal"
                                                                title="Edit Kebutuhan" data-bs-target="#kebeditmodal"><i
                                                                    class="fa fa-edit"></i></a>
                                                            <a class="text-decoration-none text-dark" id="deletekebbutton"
                                                                tipe_keb="{{ $keb->tipe_keb }}"
                                                                datakeb="{{ $keb->kode }}" data-bs-toggle="modal"
                                                                title="Hapus Kebutuhan"
                                                                data-bs-target="#kebdeletemodal"><i
                                                                    class="fa fa-xmark-circle"></i></a>
                                                        </td>
                                                        <td class="w-5 p-0 m-0 text-center">
                                                            @if ($periode->sesi == 'rka')
                                                                {{ str_replace('.', ',', $keb->jml_rka) }}
                                        ...
                                        @if (auth()->user()->role_slug == 'askpd')
                                            @if ($periode->proses == 'berjalan')
                                                <button class="badge bg-success border-0" id="kebutuhanaktaddbutton"
                                                    data-bs-toggle="modal" data-bs-placement="top"
                                                    title="Tambah Kebutuhan" data-bs-target="#kebutuhanaktaddmodala"><a
                                                        kode_akt="{{ $akt->kode }}"></a><i
                                                        class="fa fa-plus"></i></button>
                                            @endif
                                        @elseif (auth()->user()->role_slug == 'admin' || auth()->user()->role_slug == 'pengampu')
                                            <button class="badge bg-success border-0" id="kebutuhanaktaddbutton"
                                                data-bs-toggle="modal" data-bs-placement="top" title="Tambah Kebutuhan"
                                                data-bs-target="#kebutuhanaktaddmodala"><a
                                                    kode_akt="{{ $akt->kode }}"></a><i
                                                    class="fa fa-plus"></i></button>
                                        @endif
                                    </td>
                ...
                <div class="modal-body">
                    <form method="post" id="deletekakform" action="/kak/{{ $kak->kode }}" class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="kode_skpd"
                                class="form-control @error('kode_skpd') is-invalid @enderror" id="deletekakkode_skpd"
                                value="{{ old('kode_skpd', request('kode_skpd')) }}" hidden>
                            <input type="text" name="kode"
                                class="form-control @error('kode') is-invalid @enderror" id="deletekakkode"
                                value="{{ old('kode', $kak->kode_subkeg) }}" hidden>
                            <input type="text" name="periode"
                                class="form-control @error('periode') is-invalid @enderror" id="deletekakperiode"
                                value="{{ old('periode', request('periode')) }}" hidden>
                        </div>
                        ...
                        @if ($periode->sesi != 'rka')
                            <div class="mb-3">
                                ...
                                <input type="text" name="alasan"
                                    class="form-control @error('alasan') is-invalid @enderror" id="editkebalasan"
                                    value="{{ old('alasan') }}">
                            </div>
                        @endif

                        <div class="text-end">
                            <button type="submit" class="btn btn-danger"><i class="fa fa-trash"></i>Hapus Data
                                Kebutuhan</button>
                        </div>
                    </form>
                </div>
                        ...
                        <div class="row">
                            <div class="col col-xl-12">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="kode_skpd" class="form-control"
                                        id="tahapaddkode_skpd" value="{{ old('kode_skpd', request('kode_skpd')) }}"
                                        hidden>
                                    <input type="text" name="kode_kak" class="form-control" id="tahapaddkode_kak"
                                        value="{{ old('kode_kak', $kak->kode) }}" hidden>
                                    <input type="text" name="periode" class="form-control" id="tahapaddperiode"
                                        value="{{ old('periode', request('periode')) }}" hidden>
                                    <input type="text" name="ket"
                                        class="form-control @error('ket') is-invalid @enderror" id="tahapaddket"
                                        value="{{ old('ket') }}">
                                    @error('ket')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                ...
                                @if ($periode->sesi != 'rka')
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="alasan"
                                            ...
                                            id="tahapaddalasan" value="{{ old('alasan') }}">
                                    </div>
                                @endif
                            </div>
                        </div>
    ...
    <!-- Modal edit Tahap-->
    <div class="modal fade" id="tahapeditmodal" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                        ...
                        <div class="row">
                            <div class="col col-xl-12">
                                ...
                                <div class="mb-3">
                                    <label for="ket" class="form-label">Nama tahap</label>
                                    <input type="text" name="kode_skpd" class="form-control"
                                        id="tahapeditkode_skpd" value="{{ old('kode_skpd', request('kode_skpd')) }}"
                                        hidden>
                                    <input type="text" name="kode_kak" class="form-control"
                                        id="tahapeditkode_kak" value="{{ old('kode_kak', $kak->kode) }}" hidden>
                                    <input type="text" name="periode" class="form-control" id="tahapeditperiode"
                                        value="{{ old('periode', request('periode')) }}" hidden>
                                    <input type="text" name="ket"
                                        class="form-control @error('ket') is-invalid @enderror" id="tahapeditket"
                                        value="{{ old('ket') }}">
                                    @error('ket')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                ...
                                @if ($periode->sesi != 'rka')
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="alasan"
                                            class="form-control @error('alasan') is-invalid @enderror"
                                            id="tahapeditalasan" value="{{ old('alasan') }}">
                                    </div>
                                @endif
                            </div>
                        </div>
    ...
    <div class="modal fade" id="aktivitasaddmodal" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                        ...
                        <div class="row">
                            <div class="col col-xl-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="kode_skpd"
                                        class="form-control @error('kode_skpd') is-invalid @enderror"
                                        id="aktivitasaddkode_skpd"
                                        value="{{ old('kode_skpd', request('kode_skpd')) }}" hidden>
                                    <input type="text" name="kode_kak"
                                        class="form-control @error('kode_kak') is-invalid @enderror"
                                        id="aktivitasaddkode_kak" value="{{ old('kode_kak', $kak->kode) }}" hidden>
                                    <input type="text" name="periode"
                                        class="form-control @error('periode') is-invalid @enderror"
                                        id="aktivitasaddperiode" value="{{ old('periode', request('periode')) }}"
                                        hidden>
                                    <input type="text" name="kode_thp"
                                        class="form-control @error('kode_thp') is-invalid @enderror"
                                        id="aktivitasaddkode_thp" value="{{ old('kode_akt') }}" hidden>
                                    <input type="text" name="ket"
                                        class="form-control @error('ket') is-invalid @enderror" id="aktivitasaddket"
                                        value="{{ old('ket') }}">
                                    @error('ket')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <select name="bulandari" id="aktivitasaddbulandari"
                                            class="form-control @error('bulandari') is-invalid @enderror">
                                        ...
                                        @enderror
                                        <select name="minggudari" id="aktivitasaddminggudari"
                                            class="form-control @error('minggudari') is-invalid @enderror">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <select name="bulansampai" id="aktivitasaddbulansampai"
                                            class="form-control @error('bulansampai') is-invalid @enderror">
                                            <option value="">Bulan</option>
                                            <option value="1">Januari</option>
                                            <option value="2">Februari</option>
                                            <option value="3">Maret</option>
                                        ...
                                        @enderror
                                        <select name="minggusampai" id="aktivitasaddminggusampai"
                                            class="form-control @error('minggusampai') is-invalid @enderror">
                                            <option value="">minggu ke</option>
                                            <option value="1">1</option>
                                            <option value="2">2</option>
                                            <option value="3">3</option>
                                ...
                                @if ($periode->sesi != 'rka')
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="alasan"
                                            class="form-control @error('alasan') is-invalid @enderror"
                                            id="aktivitasaddalasan" value="{{ old('alasan') }}">
                                    </div>
                                @endif
                            </div>
                        </div>
    ...
    <!-- Modal edit Aktivias -->
    <div class="modal fade" id="aktivitaseditmodal" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                        ...
                        <div class="row">
                            <div class="col col-xl-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="kode_skpd"
                                        class="form-control @error('kode_skpd') is-invalid @enderror"
                                        id="aktivitaseditkode_skpd"
                                        value="{{ old('kode_skpd', request('kode_skpd')) }}" hidden>
                                    <input type="text" name="kode_kak"
                                        class="form-control @error('kode_kak') is-invalid @enderror"
                                        id="aktivitaseditkode_kak" value="{{ old('kode_kak', $kak->kode) }}" hidden>
                                    <input type="text" name="periode"
                                        class="form-control @error('periode') is-invalid @enderror"
                                        id="aktivitaseditperiode" value="{{ old('periode', request('periode')) }}"
                                        hidden>
                                    <input type="text" name="ket"
                                        class="form-control @error('ket') is-invalid @enderror" id="aktivitaseditket"
                                        value="{{ old('ket') }}">
                                    @error('ket')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                ...
                                <div class="mb-3">
                                    <label for="name" class="form-label">Dimulai</label>
                                    <div class="input-group">
                                        <select name="bulandari" id="aktivitaseditbulandari"
                                            class="form-control @error('bulandari') is-invalid @enderror">
                                            <option value="">Bulan</option>
                                            <option value="1">Januari</option>
                                            <option value="2">Februari</option>
                                        ...
                                        @enderror
                                        <select name="minggudari" id="aktivitaseditminggudari"
                                            class="form-control @error('minggudari') is-invalid @enderror">
                                            <option value="">minggu ke</option>
                                            <option value="1">1</option>
                                            <option value="2">2</option>
                                ...
                                <div class="mb-3">
                                    <label for="name" class="form-label">Berakhir</label>
                                    <div class="input-group">
                                        <select name="bulansampai" id="aktivitaseditbulansampai"
                                            class="form-control @error('bulansampai') is-invalid @enderror">
                                            <option value="">Bulan</option>
                                            <option value="1">Januari</option>
                                            <option value="2">Februari</option>
                                        ...
                                        @enderror
                                        <select name="minggusampai" id="aktivitaseditminggusampai"
                                            class="form-control @error('minggusampai') is-invalid @enderror">
                                            <option value="">minggu ke</option>
                                            <option value="1">1</option>
                                            <option value="2">2</option>
                                ...
                                @if ($periode->sesi != 'rka')
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="alasan"
                                            class="form-control @error('alasan') is-invalid @enderror"
                                            id="aktivitaseditalasan" value="{{ old('alasan') }}">
                                    </div>
                                @endif
                            </div>
                        </div>
    ...
    <!-- Modal Add Personil -->
    <div class="modal fade" id="personalaktaddmodal" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <form method="post" action="/personalakt" class="mb-5">
                        ...
                        <div class="row">
                            <div class="col col-xl-12">
                                <input type="text" name="kode_skpd"
                                    class="form-control @error('kode_skpd') is-invalid @enderror"
                                    id="personalaktaddkode_skpd" value="{{ old('kode_skpd', request('kode_skpd')) }}"
                                    hidden>
                                <input type="text" name="kode_kak"
                                    class="form-control @error('kode_kak') is-invalid @enderror"
                                    id="personalaktaddkode_kak" value="{{ old('kode_kak', $kak->kode) }}" hidden>
                                <input type="text" name="periode"
                                    class="form-control @error('periode') is-invalid @enderror"
                                    id="personalaktaddperiode" value="{{ old('periode', request('periode')) }}"
                                    hidden>
                                <input type="text" name="kode_akt"
                                    class="form-control @error('kode_akt') is-invalid @enderror"
                                    id="personalaktaddkode_akt" value="{{ old('kode_akt') }}" hidden>
                                <div class="mb-3">
                                    <label for="name" class="form-label">Nama Personil</label>
                                    <select name="personil_slug" class="form-control"
                                        id="personalaktaddpersonil_slug">
                                ...
                                <div class="mb-3" id="personalaktaddotherpersonilform">
                                    <label for="otherpersonil" class="form-label">Lainnya <small>(diisi jika tidak
                                            ditemukan dalam pilihan diatas)</small></label>
                                    <input type="text" name="otherpersonil" class="form-control"
                                        id="personalaktaddotherpersonil" value="{{ old('otherpersonil') }}">
                                </div>
                                <div class="mb-3">
                                    <label for="jumlah" class="form-label">Jumlah Personil</label>
                                    <input type="text" name="jumlah"
                                        class="form-control @error('jumlah') is-invalid @enderror"
                                        id="personalaktaddjumlah" value="{{ old('jumlah') }}">
                                    @error('jumlah')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                @if ($periode->sesi != 'rka')
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="alasan"
                                            class="form-control @error('alasan') is-invalid @enderror"
                                            id="personalaktaddalasan" value="{{ old('alasan') }}">
                                    </div>
                                @endif
                            </div>
                        </div>
    ...
    <!-- Modal Edit Personil -->
    <div class="modal fade" id="personalakteditmodal" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                        ...
                        <div class="row">
                            <div class="col col-xl-12">
                                ...
                                <div class="mb-3">
                                    <label for="name" class="form-label">Nama Personil</label>
                                    <select name="personil_slug" class="form-control"
                                        id="personalakteditpersonil_slug">
                                        <option value="">--- Pilih Personil ---</option>
                                        @foreach ($personil as $p)
                                            <option value="{{ $p->slug }}">{{ $p->name }}</option>
                                        @endforeach
                                ...
                                <div class="mb-3" id="personalakteditotherpersonilform">
                                    <label for="otherpersonil" class="form-label">Lainnya <small>(diisi jika tidak
                                            ditemukan dalam pilihan diatas)</small></label>
                                    <input type="text" name="otherpersonil" class="form-control"
                                        id="personalakteditotherpersonil" value="{{ old('otherpersonil') }}">
                                </div>
                                <div class="mb-3">
                                    <label for="jumlah" class="form-label">Jumlah Personil</label>
                                    <input type="text" name="jumlah"
                                        class="form-control @error('jumlah') is-invalid @enderror"
                                        id="personalakteditjumlah" value="{{ old('jumlah') }}">
                                    @error('jumlah')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                @if ($periode->sesi != 'rka')
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="alasan"
                                            class="form-control @error('alasan') is-invalid @enderror"
                                            id="personalakteditalasan" value="{{ old('alasan') }}">
                                    </div>
                                @endif
                            </div>
                        </div>
    ...
    <div class="modal fade" id="personalaktdeletemodal" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <form method="post" id="deletepform" action="/personalakt" class="mb-3">
                        ...
                        <div>
                            ...
                            <input type="text" name="kode_skpd"
                                class="form-control @error('kode_skpd') is-invalid @enderror" id="deleteikode_skpd"
                                value="{{ old('kode_skpd', request('kode_skpd')) }}" hidden>
                            <input type="text" name="kode_kak"
                                class="form-control @error('kode_kak') is-invalid @enderror" id="deleteikode_kak"
                                value="{{ old('kode_kak', $kak->kode) }}" hidden>
                            <input type="text" name="periode"
                                class="form-control @error('periode') is-invalid @enderror" id="deleteiperiode"
                                value="{{ old('periode', request('periode')) }}" hidden>
                        </div>
                        ...
                        @if ($periode->sesi != 'rka')
                            <div class="mb-3">
                                <label for="alasan" class="form-label">Alasan Diubah</label>
                                <input type="text" name="alasan"
                                    class="form-control @error('alasan') is-invalid @enderror" id="deletepalasan"
                                    value="{{ old('alasan') }}">
                            </div>
                        @endif
    ...
    <!-- Modal Add Instrumen -->
    <div class="modal fade" id="instruaktaddmodal" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <form method="post" action="/instruakt" class="mb-5">
                        ...
                        <div class="row">
                            <div class="col col-xl-12">
                                <input type="text" name="kode_skpd"
                                    class="form-control @error('kode_skpd') is-invalid @enderror"
                                    id="instruaddkode_skpd" value="{{ old('kode_skpd', request('kode_skpd')) }}"
                                    hidden>
                                <input type="text" name="kode_kak"
                                    class="form-control @error('kode_kak') is-invalid @enderror" id="instruaddkode_kak"
                                    value="{{ old('kode_kak', $kak->kode) }}" hidden>
                                <input type="text" name="periode"
                                    class="form-control @error('periode') is-invalid @enderror" id="instruaddperiode"
                                    value="{{ old('periode', request('periode')) }}" hidden>
                                <input type="text" name="kode_akt"
                                    class="form-control @error('kode_akt') is-invalid @enderror"
                                    id="instruaktaddkode_akt" value="{{ old('kode_akt') }}" hidden>
                                <div class="mb-3">
                                    <label for="name" class="form-label">Nama Alat</label>
                                    <select name="instruakt_slug" class="form-control"
                                        id="instruaktaddinstruakt_slug">
                                ...
                                <div class="mb-3">
                                    <label for="otherinstru" class="form-label">Lainnya <small>(diisi jika tidak
                                            ditemukan dalam pilihan diatas)</small></label>
                                    <input type="text" name="otherinstru" class="form-control"
                                        id="instruaktaddotherinstru" value="{{ old('otherpersonil') }}">
                                </div>
                                <div class="mb-3">
                                    <label for="jumlah" class="form-label">Jumlah Alat</label>
                                    <input type="text" name="jumlah"
                                        class="form-control @error('jumlah') is-invalid @enderror"
                                        id="instruaktaddjumlah" value="{{ old('jumlah') }}">
                                    @error('jumlah')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                @if ($periode->sesi != 'rka')
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="alasan"
                                            class="form-control @error('alasan') is-invalid @enderror"
                                            id="instruaktaddalasan" value="{{ old('alasan') }}">
                                    </div>
                                @endif
                            </div>
                        </div>
    ...
    <div class="modal fade" id="instruakteditmodal" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                        ...
                        <div class="row">
                            <div class="col col-xl-12">
                                ...
                                <div class="mb-3">
                                    <label for="name" class="form-label">Nama Alat</label>
                                    <select name="instruakt_slug" class="form-control"
                                        id="instruakteditinstruakt_slug">
                                        <option value="">--- Pilih Alat ---</option>
                                        @foreach ($instrumen as $i)
                                            <option value="{{ $i->slug }}">{{ $i->name }}</option>
                                        @endforeach
                                ...
                                <div class="mb-3">
                                    <label for="otherinstru" class="form-label">Lainnya <small>(diisi jika tidak
                                            ditemukan dalam pilihan diatas)</small></label>
                                    <input type="text" name="otherinstru" class="form-control"
                                        id="instruakteditotherinstru" value="{{ old('otherpersonil') }}">
                                </div>
                                <div class="mb-3">
                                    <label for="jumlah" class="form-label">Jumlah Alat</label>
                                    <input type="text" name="jumlah"
                                        class="form-control @error('jumlah') is-invalid @enderror"
                                        id="instruakteditjumlah" value="{{ old('jumlah') }}">
                                    @error('jumlah')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                @if ($periode->sesi != 'rka')
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="alasan"
                                            class="form-control @error('alasan') is-invalid @enderror"
                                            id="instruakteditalasan" value="{{ old('alasan') }}">
                                    </div>
                                @endif
                            </div>
                        </div>
    ...
    <!-- Modal Delete Instrumen -->
    <div class="modal fade" id="instruaktdeletemodal" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <form method="post" id="deleteiform" action="/instruakt" class="mb-3">
                        ...
                        @if ($periode->sesi != 'rka')
                            <div class="mb-3">
                                <label for="alasan" class="form-label">Alasan Diubah</label>
                                <input type="text" name="alasan"
                                    class="form-control @error('alasan') is-invalid @enderror" id="deleteialasan"
                                    value="{{ old('alasan') }}">
                            </div>
                        @endif
    ...
    <div class="modal fade" id="dataaktaddmodal" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <form method="post" action="/dataakt" class="mb-5">
                        ...
                        <div class="row">
                            <div class="col col-xl-12">
                                <input type="text" name="kode_skpd"
                                    class="form-control @error('kode_skpd') is-invalid @enderror" id="dataaddkode_skpd"
                                    value="{{ old('kode_skpd', request('kode_skpd')) }}" hidden>
                                <input type="text" name="kode_kak"
                                    class="form-control @error('kode_kak') is-invalid @enderror" id="dataaddkode_kak"
                                    value="{{ old('kode_kak', $kak->kode) }}" hidden>
                                <input type="text" name="periode"
                                    class="form-control @error('periode') is-invalid @enderror" id="dataaddperiode"
                                    value="{{ old('periode', request('periode')) }}" hidden>
                                <input type="text" name="kode_akt"
                                    class="form-control @error('kode_akt') is-invalid @enderror"
                                    id="dataaktaddkode_akt" value="{{ old('kode_akt') }}" hidden>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="otherdata"
                                        class="form-control @error('otherdata') is-invalid @enderror"
                                        id="dataaktaddotherdata" value="{{ old('otherdata') }}">
                                </div>
                                @if ($periode->sesi != 'rka')
                                    <div class="mb-3">
                                        <label for="alasan" class="form-label">Alasan Diubah</label>
                                        <input type="text" name="alasan"
                                            class="form-control @error('alasan') is-invalid @enderror"
                                            id="dataaktaddalasan" value="{{ old('alasan') }}">
                                    </div>
                                @endif
                            </div>
                        </div>
    ...
    <div class="modal fade" id="dataakteditmodal" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                        ...
                        <div class="row">
                            <div class="col col-xl-12">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="otherdata"
                                        class="form-control @error('otherdata') is-invalid @enderror"
                                        id="dataakteditotherdata" value="{{ old('otherdata') }}">
                                </div>
                                @if ($periode->sesi != 'rka')
                                    <div class="mb-3">
                                        <label for="alasan" class="form-label">Alasan Diubah</label>
                                        <input type="text" name="alasan"
                                            class="form-control @error('alasan') is-invalid @enderror"
                                            id="dataakteditalasan" value="{{ old('alasan') }}">
                                    </div>
                                @endif
                            </div>
                        </div>
    ...
    <div class="modal fade" id="dataaktdeletemodal" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <form method="post" id="deletedform" action="/dataakt" class="mb-3">
                        ...
                        <div>
                            ...
                            <input type="text" name="kode_skpd"
                                class="form-control @error('kode_skpd') is-invalid @enderror" id="deletekebkode_skpd"
                                value="{{ old('kode_skpd', request('kode_skpd')) }}" hidden>
                            <input type="text" name="kode_kak"
                                class="form-control @error('kode_kak') is-invalid @enderror" id="deletekebkode_kak"
                                value="{{ old('kode_kak', $kak->kode) }}" hidden>
                            <input type="text" name="periode"
                                class="form-control @error('periode') is-invalid @enderror" id="deletekebperiode"
                                value="{{ old('periode', request('periode')) }}" hidden>
                        </div>
                        ...
                        @if ($periode->sesi != 'rka')
                            <div class="mb-3">
                                <label for="alasan" class="form-label">Alasan Diubah</label>
                                <input type="text" name="alasan"
                                    class="form-control @error('alasan') is-invalid @enderror" id="deletedalasan"
                                    value="{{ old('alasan') }}">
                            </div>
                        @endif
    ...
    <!-- Modal Add Kebutuhan -->
    {{-- modal ssh --}}
    <div class="modal fade" id="kebutuhanaktaddmodala" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <ul class="nav nav-tabs">
                        <li class="nav-item">
                            <a class="nav-link text-decoration-none text-dark active" id="aa"
                                data-bs-toggle="modal" data-bs-target="#a">SSH</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-decoration-none text-dark" id="ab" data-bs-toggle="modal"
                                data-bs-target="#kebutuhanaktaddmodalb">SBU</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-decoration-none text-dark" id="ac" data-bs-toggle="modal"
                                data-bs-target="#kebutuhanaktaddmodalc">Non SSH / SBU</a>
                        </li>
                    </ul>
                    <div class="row">
                        <div class="col col-xl-12">
                            <div class="row">
                                <div class="col col-xl-12">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="sshaddcari"
                                                placeholder="Cari nama kebutuhan">
                                            <button class="btn btn-primary" id="sshaddcaributton" type="button"><i
                                                    class="fa fa-magnifying-glass"></i> Cari</button>
                                        </div>
                            ...
                            <div id="sshaddform" style="display: none;">
                                <form method="post" action="/kebutuhanakt" class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="kode_skpd"
                                            class="form-control @error('kode_skpd') is-invalid @enderror"
                                            id="sshaddkode_skpd" value="{{ old('kode_skpd', request('kode_skpd')) }}"
                                            hidden>
                                        <input type="text" name="kode_kak"
                                            class="form-control @error('kode_kak') is-invalid @enderror"
                                            id="sshaddkode_kak" value="{{ old('kode_kak', $kak->kode) }}" hidden>
                                        <input type="text" name="periode"
                                            class="form-control @error('periode') is-invalid @enderror"
                                            id="sshaddperiode" value="{{ old('periode', request('periode')) }}"
                                            hidden>
                                        <input type="text" name="kode_akt"
                                            class="form-control @error('kode_akt') is-invalid @enderror"
                                            id="sshaddkode_akt" value="{{ old('kode_akt') }}" hidden>
                                        <input type="text" name="kode_item" class="form-control"
                                            id="sshaddkode_item" value="{{ old('kode_item') }}" hidden>
                                        <input type="text" name="tipe_keb" class="form-control"
                                            id="sshaddtipe_keb" value="{{ old('tipe_keb') }}" hidden>
                                        ...
                                        <div class="col col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="harga"
                                                    ...
                                                    id="sshaddharga" value="{{ old('harga') }}" readonly>
                                                @error('harga')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="col col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" name="jumlah"
                                                        class="form-control @error('jumlah') is-invalid @enderror"
                                                        id="sshaddjumlah" value="{{ old('jumlah', 1) }}">
                                    ...
                                    @if ($periode->sesi != 'rka')
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="alasan"
                                                class="form-control @error('alasan') is-invalid @enderror"
                                                id="sshaddalasan" value="{{ old('alasan') }}">
                                        </div>
                                    @endif
                                    <div class="mb-5">
                                        <label for="total" class="form-label">Total</label>
                                        <input type="text" name="total"
                                            class="form-control @error('total') is-invalid @enderror" id="sshaddtotal"
                                    ...
                                    <div class="mb-3" id="sshaddupdatehargaform" style="display: none">
                                        ...
                                        <input type="text" name="update_harga" class="form-control"
                                            id="sshaddupdate_harga" value="{{ old('update_harga') }}">
                                    </div>
                                    <div class="text-end">
                            ...
                            <div id="usshaddform" style="display: none;">
                                <form method="post" action="/kebutuhanakt" class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="kode_skpd"
                                            class="form-control @error('kode_skpd') is-invalid @enderror"
                                            id="usshaddkode_skpd" value="{{ old('kode_skpd', request('kode_skpd')) }}"
                                            hidden>
                                        <input type="text" name="kode_kak"
                                            class="form-control @error('kode_kak') is-invalid @enderror"
                                            id="usshaddkode_kak" value="{{ old('kode_kak', $kak->kode) }}" hidden>
                                        <input type="text" name="periode"
                                            class="form-control @error('periode') is-invalid @enderror"
                                            id="usshaddperiode" value="{{ old('periode', request('periode')) }}"
                                            hidden>
                                        <input type="text" name="kode_akt"
                                            class="form-control @error('kode_akt') is-invalid @enderror"
                                            id="usshaddkode_akt" value="{{ old('kode_akt') }}" hidden>
                                        <input type="text" name="kode_item" class="form-control"
                                            id="usshaddkode_item" value="{{ old('kode_item') }}" hidden>
                                        <input type="text" name="tipe_keb" class="form-control"
                                            id="usshaddtipe_keb" value="{{ old('tipe_keb') }}" hidden>
                                        <textarea name="uraian_lain" class="form-control" id="usshadditem_name" rows="3"></textarea>
                                    </div>
                                    <div class="mb-3">
                                        <label for="harga" class="form-label">Harga</label>
                                        <input type="text" name="harga"
                                            class="form-control @error('harga') is-invalid @enderror" id="usshaddharga"
                                            value="{{ old('harga') }}">
                                        @error('harga')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                    ...
                                    <div class="row">
                                        <div class="col col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" name="jumlah"
                                                        class="form-control @error('jumlah') is-invalid @enderror"
                                                        id="usshaddjumlah" value="{{ old('jumlah', 1) }}">
                                                </div>
                                                @error('jumlah')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                        ...
                                        <div class="col col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group">
                                                    <select name="satuan_id" id="usshaddsatuan_id"
                                                        class="form-select">
                                                        @foreach ($satuan as $sat)
                                                            <option value="{{ $sat->id }}">{!! strtolower($sat->satuan) !!}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                    ...
                                    @if ($periode->sesi != 'rka')
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="alasan"
                                                class="form-control @error('alasan') is-invalid @enderror"
                                                id="usshaddalasan" value="{{ old('alasan') }}">
                                        </div>
                                    @endif
                                    <div class="mb-5">
                                        <label for="total" class="form-label">Total</label>
                                        <input type="text" name="total"
                                            class="form-control @error('total') is-invalid @enderror" id="usshaddtotal"
                                            value="{{ old('total') }}" readonly>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3" id="usshaddupdatehargaform" style="display: none">
                                        <label for="" class="form-label">Harga terupdate</label>
                                        <input type="text" name="update_harga" class="form-control"
                                            id="usshaddupdate_harga" value="{{ old('update_harga') }}">
                                    </div>
                                    <div class="text-end">
                                        <button type="submit" class="btn btn-primary">Tambah Data Kebutuhan</button>
                                    </div>
    ...
    {{-- modal sbu --}}
    <div class="modal fade" id="kebutuhanaktaddmodalb" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <ul class="nav nav-tabs">
                        <li class="nav-item">
                            <a class="nav-link text-decoration-none text-dark" id="aa" data-bs-toggle="modal"
                                data-bs-target="#kebutuhanaktaddmodala">SSH</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-decoration-none text-dark active" id="ab"
                                data-bs-toggle="modal" data-bs-target="#kebutuhanaktaddmodalb">SBU</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-decoration-none text-dark" id="ac" data-bs-toggle="modal"
                                data-bs-target="#kebutuhanaktaddmodalc">Non SSH / SBU</a>
                            ...
                            <div class="row">
                                <div class="col col-xl-12">
                                    <div class="mb-3">
                                        <label for="cari" class="form-label">Cari</label>
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="sbuaddcari"
                                                list="cari" placeholder="Cari nama kebutuhan"
                                                aria-label="Recipient's username" aria-describedby="button-addon2">
                                            <button class="btn btn-outline-secondary" id="sbuaddcaributton"
                            ...
                            <div id="sbuaddform" style="display: none;">
                                <form method="post" action="/kebutuhanakt" class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="kode_skpd"
                                            class="form-control @error('kode_skpd') is-invalid @enderror"
                                            id="sbuaddkode_skpd" value="{{ old('kode_skpd', request('kode_skpd')) }}"
                                            hidden>
                                        <input type="text" name="kode_kak"
                                            class="form-control @error('kode_kak') is-invalid @enderror"
                                            id="sbuaddkode_kak" value="{{ old('kode_kak', $kak->kode) }}" hidden>
                                        <input type="text" name="periode"
                                            class="form-control @error('periode') is-invalid @enderror"
                                            id="sbuaddperiode" value="{{ old('periode', request('periode')) }}"
                                            hidden>
                                        <input type="text" name="kode_akt"
                                            class="form-control @error('kode_akt') is-invalid @enderror"
                                            id="sbuaddkode_akt" value="{{ old('kode_akt') }}" hidden>
                                        <input type="text" name="kode_item" class="form-control"
                                            id="sbuaddkode_item" value="{{ old('kode_item') }}" hidden>
                                        <input type="text" name="tipe_keb" class="form-control"
                                            id="sbuaddtipe_keb" value="{{ old('tipe_keb') }}" hidden>
                                    ...
                                    <div class="row">
                                        <div class="col col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="harga"
                                                    class="form-control @error('harga') is-invalid @enderror"
                                                    id="sbuaddharga" value="{{ old('harga') }}" readonly>
                                                @error('harga')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="col col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" name="jumlah"
                                                        class="form-control @error('jumlah') is-invalid @enderror"
                                                        id="sbuaddjumlah" value="{{ old('jumlah', 1) }}">
                                    ...
                                    @if ($periode->sesi != 'rka')
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="alasan"
                                                class="form-control @error('alasan') is-invalid @enderror"
                                                id="sbuaddalasan" value="{{ old('alasan') }}">
                                        </div>
                                    @endif
                                    <div class="mb-5">
                                        <label for="total" class="form-label">Total</label>
                                        <input type="text" name="total"
                                            class="form-control @error('total') is-invalid @enderror" id="sbuaddtotal"
                                            value="{{ old('total') }}" readonly>
                                    </div>
                                    <div class="text-end">
                                        <button type="submit" class="btn btn-primary">Tambah Data Kebutuhan</button>
                            ...
                            <div id="usbuaddform" style="display: none;">
                                <form method="post" action="/kebutuhanakt" class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="kode_skpd"
                                            class="form-control @error('kode_skpd') is-invalid @enderror"
                                            id="usbuaddkode_skpd" value="{{ old('kode_skpd', request('kode_skpd')) }}"
                                            hidden>
                                        <input type="text" name="kode_kak"
                                            class="form-control @error('kode_kak') is-invalid @enderror"
                                            id="usbuaddkode_kak" value="{{ old('kode_kak', $kak->kode) }}" hidden>
                                        <input type="text" name="periode"
                                            class="form-control @error('periode') is-invalid @enderror"
                                            id="usbuaddperiode" value="{{ old('periode', request('periode')) }}"
                                            hidden>
                                        <input type="text" name="kode_akt"
                                            class="form-control @error('kode_akt') is-invalid @enderror"
                                            id="usbuaddkode_akt" value="{{ old('kode_akt') }}" hidden>
                                        <input type="text" name="kode_item" class="form-control"
                                            id="usbuaddkode_item" value="{{ old('kode_item') }}" hidden>
                                        <input type="text" name="tipe_keb" class="form-control"
                                            id="usbuaddtipe_keb" value="{{ old('tipe_keb') }}" hidden>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="harga"
                                            class="form-control @error('harga') is-invalid @enderror"
                                            id="usbuaddharga" value="{{ old('harga') }}">
                                        @error('harga')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" name="jumlah"
                                                        class="form-control @error('jumlah') is-invalid @enderror"
                                                        id="usbuaddjumlah" value="{{ old('jumlah', 1) }}">
                                                </div>
                                                @error('jumlah')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                        ...
                                        <div class="col col-md-6">
                                            <div class="mb-3">
                                                <label for="satuan_id" class="form-label">Satuan</label>
                                                <div class="input-group">
                                                    <select name="satuan_id" id="usbuaddsatuan_id"
                                                        class="form-select">
                                                        @foreach ($satuan as $sat)
                                                            <option value="{{ $sat->id }}">{!! strtolower($sat->satuan) !!}
                                                            </option>
                                    ...
                                    @if ($periode->sesi != 'rka')
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="alasan"
                                                class="form-control @error('alasan') is-invalid @enderror"
                                                id="usbuaddalasan" value="{{ old('alasan') }}">
                                        </div>
                                    @endif
                                    <div class="mb-5">
                                        <label for="total" class="form-label">Total</label>
                                        <input type="text" name="total"
                                            ...
                                            id="usbuaddtotal" value="{{ old('total') }}" readonly>
                                    </div>
                                    <div class="text-end">
                                        <button type="submit" class="btn btn-primary">Tambah Data Kebutuhan</button>
                                    </div>
    ...
    <!-- End Modal Create -->
    {{-- modal LAinnya --}}
    <div class="modal fade" id="kebutuhanaktaddmodalc" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-decoration-none text-dark active" id="ac"
                                data-bs-toggle="modal" data-bs-target="#kebutuhanaktaddmodalc">Non SSH / SBU</a>
                        </li>
                    </ul>
                    <div class="row">
                        <div class="col col-xl-12">
                            <form method="post" action="/kebutuhanakt" class="mb-3">
                                @csrf
                                <div class="mb-3">
                                    <label for="" class="form-label">Uraian <small class="text-danger">*Wajib
                                            Diisi</small></label>
                                    <input type="text" name="kode_skpd"
                                        class="form-control @error('kode_skpd') is-invalid @enderror"
                                        id="otheraddkode_skpd" value="{{ old('kode_skpd', request('kode_skpd')) }}"
                                        hidden>
                                    <input type="text" name="kode_kak"
                                        class="form-control @error('kode_kak') is-invalid @enderror"
                                        id="otheraddkode_kak" value="{{ old('kode_kak', $kak->kode) }}" hidden>
                                    <input type="text" name="periode"
                                        class="form-control @error('periode') is-invalid @enderror"
                                        id="otheraddperiode" value="{{ old('periode', request('periode')) }}" hidden>
                                    <input type="text" name="kode_akt"
                                        class="form-control @error('kode_akt') is-invalid @enderror"
                                        id="otheraddkode_akt" value="{{ old('kode_akt') }}" hidden>
                                    <input type="text" name="tipe_keb" class="form-control" id="otheraddtipe_keb"
                                        value="other" hidden>
                                ...
                                <div class="row">
                                    <div class="col col-md-6">
                                        <div class="mb-3">
                                            <label for="jumlah" class="form-label">jumlah <small>(Gunakan titik (.)
                                                    jika ada koma)</small> <small class="text-danger">*Wajib
                                                    Diisi</small></label>
                                            <input type="text" name="jumlah"
                                                class="form-control @error('jumlah') is-invalid @enderror"
                                                id="otheraddjumlah" value="{{ old('jumlah', 1) }}">
                                            @error('jumlah')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                ...
                                <div class="mb-5">
                                    <label for="total" class="form-label">Jumlah Pagu <small
                                            class="text-danger">*Wajib Diisi</small></label>
                                    <input type="text" name="total"
                                        class="form-control @error('total') is-invalid @enderror" id="otheraddtotal"
                                        value="{{ old('total') }}">
                                </div>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="kebeditmodal" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
                ...
                <div class="modal-body">
                    <form method="post" id="editkebform" action="/kebutuhanakt" class="mb-3">
                        ...
                        <div class="mb-3">
                            <label for="" class="form-label">Data Kebutuhan</label>
                            <input type="text" name="kode_skpd"
                                class="form-control @error('kode_skpd') is-invalid @enderror" id="editkebkode_skpd"
                                value="{{ old('kode_skpd', request('kode_skpd')) }}" hidden>
                            <input type="text" name="kode_kak"
                                class="form-control @error('kode_kak') is-invalid @enderror" id="editkebkode_kak"
                                value="{{ old('kode_kak', $kak->kode) }}" hidden>
                            <input type="text" name="periode"
                                class="form-control @error('periode') is-invalid @enderror" id="editkebperiode"
                                value="{{ old('periode', request('periode')) }}" hidden>
                            <input type="text" name="kode"
                                class="form-control @error('kode') is-invalid @enderror" id="editkebkode"
                                value="{{ old('kode') }}" hidden>
                            <input type="text" name="tipe_keb"
                                class="form-control @error('tipe_keb') is-invalid @enderror" id="editkebtipe_keb"
                                value="{{ old('tipe_keb') }}" hidden>
                        ...
                        <div class="row">
                            <div class="col col-md-6">
                                <div class="mb-3">
                                    <label for="harga" class="form-label">Harga</label>
                                    <input type="text" name="harga"
                                        class="form-control @error('harga') is-invalid @enderror" id="editkebharga"
                            ...
                            <div class="col col-md-6">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="jumlah"
                                            class="form-control @error('jumlah') is-invalid @enderror"
                                            id="editkebjumlah" value="{{ old('jumlah', 1) }}">
                        ...
                        <div class="mb-5">
                            <label for="total" class="form-label">Total</label>
                            <input type="text" name="total"
                                class="form-control @error('total') is-invalid @enderror" id="editkebtotal"
                                value="{{ old('total') }}" readonly>
                        </div>
                        <div class="text-end">
    ...
    <div class="modal fade" id="kebdeletemodal" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <!-- Modal Edit Other -->
    <div class="modal fade" id="editothermodal" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                        ...
                        <div class="row">
                            <div class="col col-xl-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="aktivitas_id" class="form-control"
                                        id="editotheraktivitas_id" value="{{ old('aktivitas_id') }}" hidden>
                                    <input type="text" name="kode_kak" class="form-control"
                                        id="editotherkode_kak" value="{{ old('kode_kak') }}" hidden>
                                    <input type="text" name="tipe_keb" class="form-control"
                                        id="editothertipe_keb" value="{{ old('tipe_keb') }}" hidden>
                                    <input type="text" name="otheruraian" class="form-control"
                                        id="editotheruraian" value="{{ old('otheruraian') }}">
                                </div>
                                <div class="row">
                                    <div class="col col-md-6">
                                        <div class="mb-3">
                                            <label for="jumlah" class="form-label">jumlah <small>(Gunakan titik (.)
                                                    jika ada koma)</small></label>
                                            <input type="text" name="jumlah"
                                                class="form-control @error('jumlah') is-invalid @enderror"
                                                id="editotherjumlah" value="{{ old('jumlah', 1) }}">
                                            @error('jumlah')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="col col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="satuan"
                                                ...
                                                id="editothersatuan" value="{{ old('satuan') }}" list="satuanopt">
                                            <datalist id="satuanopt">
                                                @foreach ($satuan as $s)
                                                    <option value="{{ $s->slug }}" class="form-control">
                                                        {!! $s->name !!}</option>
                                                @endforeach
                                            </datalist>
                                            @error('satuan')
                                ...
                                <div class="mb-5">
                                    ...
                                    <input type="text" name="total"
                                        class="form-control @error('total') is-invalid @enderror" id="editothertotal"
                                        value="{{ old('total') }}">
                                </div>
                            </div>
                        </div>
    ...
    <div class="modal fade" id="printoutmodal" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post"
                        action="/cetaklaporan?tipe=kak&getlaporan=kak&kode_skpd={{ request('kode_skpd') }}&kode={{ request('kode') }}&periode={{ request('periode') }}"
                        class="mb-5">
                        @csrf
                        <div class="row">
                            <div class="col col-xl-12">
        ...
        $(document).ready(function() {
            ...
            $("#tbody #aktivitaseditbutton").click(function(e) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        $("#aktivitaseditmodal #aktivitaseditform").attr("action",
                            "/aktivitas/" + aktivitas);
                        $("#aktivitaseditmodal #aktivitaseditkode_thp").val(tahap);
                        $("#aktivitaseditmodal #aktivitaseditket").val(data.ket);
                        $("#aktivitaseditmodal #aktivitaseditbulandari").val(data.bulandari)
                            .change();
                        $("#aktivitaseditmodal #aktivitaseditminggudari").val(data.minggudari)
                            .change();
                        $("#aktivitaseditmodal #aktivitaseditbulansampai").val(data.bulansampai)
                            .change();
                        $("#aktivitaseditmodal #aktivitaseditminggusampai").val(data
                            .minggusampai).change();
                    }
                });
            });
            ...
            $("#tbody").on("click", "#personalakteditbutton", function(e) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        $("#personalakteditmodal #personalakteditform").attr("action",
                            "/personalakt/" + personalakt);
                        $("#personalakteditmodal #personalakteditpersonil_slug").val(data
                            .personil_slug).change();
                        $("#personalakteditmodal #personalakteditotherpersonil").val(data
                            .otherpersonil);
            ...
            $("#tbody #personalaktdeletebutton").click(function(e) {
                ...
                $.ajax({
                    type: "GET",
                    url: "/getdatawith?tbl=App\\Personalakt&whr=kode_pers&id=" + kode + "&with=" +
                        _with,
                    success: function(data) {
            ...
            $("#tbody").on("click", "#instruakteditbutton", function(e) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        $("#instruakteditmodal #instruakteditform").attr("action",
                            "/instruakt/" + instruakt);
                        $("#instruakteditmodal #instruakteditinstruakt_slug").val(data
                            .instruakt_slug).change();
                        $("#instruakteditmodal #instruakteditotherinstru").val(data
                        .otherinstru);
            ...
            $("#tbody #instruaktdeletebutton").click(function(e) {
                ...
                $.ajax({
                    type: "GET",
                    url: "/getdatawith?tbl=App\\Instruakt&whr=kode_instruakt&id=" + kode +
                        "&with=" + _with,
                    success: function(data) {
            ...
            $("#tbody").on("click", "#dataakteditbutton", function(e) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        $("#dataakteditmodal #dataakteditform").attr("action", "/dataakt/" +
                            dataakt);
                        $("#dataakteditmodal #dataakteditdatakeg_slug").val(data.datakeg_slug)
                            .change();
            ...
            $("#tbody #dataaktdeletebutton").click(function(e) {
                ...
                $.ajax({
                    type: "GET",
                    url: "/getdatawith?tbl=App\\Dataakt&whr=kode_dataakt&id=" + kode + "&with=" +
                        _with,
                    success: function(data) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $.each(data, function(index, value) {
                            var i = index + 1;
                            tr += "<tr class='clickable' id='sshdata' kebid='" + data[
                                    index].id + "' ket='" + data[index].ket +
                                "' harga='" + data[index].harga_std + "' satuan='" +
                                data[index].satuan.satuan + "' spek='" + data[index]
                                .spek + "' tipe_keb='ssh'><td>" + i + ".</td><td>" +
                                data[index].ket + "</td><td>" + data[index].spek +
                                "</td><td>" + data[index].harga_std + "</td><td>" +
                                data[index].satuan.satuan + "</td></tr>";
                        });
                        tr +=
                            "<tr class='clickable' id='checkusulan'><td colspan='5'><i class='fa fa-magnifying-glass'></i> Lihat Usulan Pengguna untuk pencarian ini</td></tr>";
                        tbody.html(tr);
                    ...
                    success: function(data) {
                        ...
                        $.each(data, function(index, value) {
                            ...
                            tr += "<tr class='clickable' id='sshdata' kebid='" + data[
                                ...
                                "' harga='" + data[index].harga_std + "' satuan='" +
                                data[index].satuan.satuan + "' spek='" + data[index]
                                .spek + "' tipe_keb='dariusulanssh'><td>" + i +
                                ".</td><td>" + data[index].ket + "</td><td>" + data[
                                    index].spek + "</td><td>" + data[index].harga_std +
                                "</td><td>" + data[index].satuan.satuan + "</td></tr>";
                        });
                        tr +=
                            "<tr class='clickable' id='usulanssh' tipe_keb='usulanssh'><td colspan='5'><i class='fa fa-circle-plus'></i> Tambahkan Usulan SSH</td></tr>";
                        tbody.html(tr);
                        tblmodal.css("display", "block");
                    }
                });
            ...
            $("#kebutuhanaktaddmodalb #sbuaddcaributton").click(function(e) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $.each(data, function(index, value) {
                            var i = index + 1;
                            tr += "<tr class='clickable' id='sbudata' kebid='" + data[
                                    index].id + "' ket='" + data[index].ket +
                                "' harga='" + data[index].harga + "' satuan='' spek='" +
                                data[index].kali + "' tipe_keb='sbu'><td>" + i +
                                ".</td><td>" + data[index].ket + "</td><td>" + data[
                                    index].harga + "</td></tr>";
                        });
                        tr +=
                    ...
                    success: function(data) {
                        ...
                        $.each(data, function(index, value) {
                            ...
                            tr += "<tr class='clickable' id='sbudata' kebid='" + data[
                                    index].id + "' ket='" + data[index].ket +
                                "' harga='" + data[index].harga + "' satuan='' spek='" +
                                data[index].kali + "' tipe_keb='dariusulansbu'><td>" +
                                i + ".</td><td>" + data[index].ket + "</td><td>" + data[
                                    index].harga + "</td></tr>";
                        });
                        tr +=
                            "<tr class='clickable' id='usulansbu' tipe_keb='usulansbu'><td colspan='5'><i class='fa fa-circle-plus'></i> Tambahkan Usulan sbu</td></tr>";
                        tbody.html(tr);
                        tblmodal.css("display", "block");
                    }
                });
            ...
            $("#tbody #editkebbutton").click(function(e) {
                ...
                if (tipe_keb != 'ssh' && tipe_keb != 'usulanssh' && tipe_keb != 'sbu' && tipe_keb !=
                    'usulansbu') {
                    tipe_keb = '';
                }
