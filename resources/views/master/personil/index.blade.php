...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Personil Dalam Kegiatan</h1>
      ...
      <tbody id="tbody">
        @foreach ($personil as $p)
          <tr>
              ...
              <td>{{ $p->name }}</td>
              <td>
                <button class="badge bg-warning border-0" id="editbutton" data-bs-toggle="modal" data-bs-target="#editmodal"><a href="{{ $p->slug }}"></a><i class="fa fa-edit"></i></button>
                <form action="/personil/{{ $p->id }}" method="post" class="d-inline">
                  @method('delete')
                  @csrf
